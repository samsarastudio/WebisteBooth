...
export const metadata: Metadata = {
  ...
  description:
    'On-site custom sticker experiences. Print and cut photo stickers, labels, and favours for your guests.',
}
        ...
        <div className="container-wide relative z-10 grid lg:grid-cols-2 gap-10 items-center">
          <Reveal>
            ...
            <p className="text-text-secondary text-lg leading-relaxed mb-6">
              ...
              stickers, labels, and favours, printed and cut on the spot in vivid colour.
            </p>
        ...
        <div className="container-wide">
          <Reveal className="text-center mb-10 md:mb-12">
            ...
            <p className="text-text-secondary max-w-2xl mx-auto">
              On-site sticker experiences follow the same rhythm as our magnet packages. Attendant
              included, three hours of coverage (setup excluded), and capacity sized to your guest
              count. Book on its own or with fridge magnets.
            </p>
          </Reveal>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Reveal className="card p-6 space-y-3">
              ...
              <ul className="space-y-2 text-sm text-text-secondary">
                ...
                <li>Capacity varies by guest count and sticker size. We quote custom.</li>
            ...
            <Reveal delay={0.06} className="card p-6 space-y-3">
              ...
              <p className="text-sm text-text-secondary leading-relaxed">
                100-guest wedding cocktail hour: 2×3″ photo stickers with an attendant, sized for
        ...
        <div className="container-wide">
          <Reveal className="text-center mb-10 md:mb-12">
            ...
            <p className="text-text-secondary max-w-xl mx-auto">
              A playful favour that feels personal. Stickers they can wear, share, and keep.
            </p>
          </Reveal>
        ...
        <div className="container-wide max-w-3xl mx-auto text-center">
          <Reveal>
            ...
            <p className="text-text-secondary leading-relaxed mb-8">
              ...
              our custom fridge magnets for a full guest-favour night, or book stickers on their own.
            </p>
